...
public class StreamController {
    ...
    public List<Meetup> getAllMeetups(){
        ...
        return serviceClient.getAllOfTheMeetups();
    ...
    public Meetup addMeetup(@RequestBody Meetup meetup) {
        ...
        return serviceClient.creatingANewMeetup(meetup);
    }
    ...
    public List<Meetup> getAllUsers(){
        ...
        return serviceClient.getAllOfTheUsers();
    ...
    public User addUser(@RequestBody User user) {
        ...
        return serviceClient.creatingANewUser(user);
    }
}
